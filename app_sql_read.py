...
# Print the year of release for the "Kindergarten Cop" movie
print(f"The movie Kindergarten Cop was released in 1990")
print("Getting data")
db_name = "db.sqlite3"
...
"""
Notes:
You now have  variable movies, which is a list of all the data in the database
