...
# Example
birth = input(
    "With is your birthdate? Enter as Month/Day/Year like 02/28/1908:")
# convert string input into a datetime object
birt_date = datetime.strptime(birth, "%m/%d/%Y")
print(birth_date)
date_now = datetime.now()
duration_seconds = date_now - birth_date
print(f"You have a happy life of {duration_seconds}.")
