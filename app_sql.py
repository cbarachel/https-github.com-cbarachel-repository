...
with sqlite3.connect(db_name) as conn:
    ...
    for movie in movies:
        # movies is a list of dictionaries previosly read from a json file
...
Because movie is a dictionary, we have to convert movie .values() to a tople or a list
on line 53 orior to conn.execute().
Why is movie a dictionary, because movies is a list of dictionaries. Movie was created 
